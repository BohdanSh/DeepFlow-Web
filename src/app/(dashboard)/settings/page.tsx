...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white max-w-2xl mx-auto space-y-8">
      <div>
      ...
      {/* Preferences Section */}
      <section className="bg-gray-800 rounded-xl border border-gray-700 p-6">
        <h2 className="text-lg font-semibold text-white mb-4">🎛️ Preferences</h2>
      ...
      <section className="bg-gray-800 rounded-xl border border-gray-700 p-6">
        ...
        <div className="space-y-4">
          <label className="flex items-center justify-between cursor-pointer p-3 bg-gray-900/50 rounded-lg hover:bg-gray-900 transition-colors">
            <div>
          ...
          <label className="flex items-center justify-between cursor-pointer p-3 bg-gray-900/50 rounded-lg hover:bg-gray-900 transition-colors">
            <div>
              ...
              <p className="text-sm text-gray-400">Get a summary of your tasks every morning</p>
            </div>
            <input
              type="checkbox"
              checked={dailyDigest}
          ...
          <label className="flex items-center justify-between cursor-pointer p-3 bg-gray-900/50 rounded-lg hover:bg-gray-900 transition-colors">
            <div>
              ...
              <p className="text-sm text-gray-400">Remind me about upcoming due dates</p>
            </div>
            <input
              type="checkbox"
      ...
      <section className="bg-gray-800 rounded-xl border border-gray-700 p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="font-medium text-white">
              Current Plan: {' '}
              <span className={subscriptionStatus === 'pro' ? 'text-purple-400' : 'text-gray-400'}>
        ...
        <div className="grid grid-cols-3 gap-4 p-4 bg-gray-900 rounded-lg">
          <div className="text-center">
            <p className="text-2xl font-bold text-blue-400">{stats.goals}</p>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3 bg-gray-900/50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-400">Delete all your goals and tasks. This cannot be undone.</p>
            </div>
            <button
              onClick={() => setShowDeleteDataModal(true)}
              className="px-4 py-2 border border-red-500/50 text-red-400 rounded-lg hover:bg-red-500/20 transition-colors"
            >
              Delete Data
            </button>
          </div>
